...
public class App 
{
    public static void main( String[] args ) throws URISyntaxException
    {
     ...
     //   System.out.println("App.class.getResource(fileName).toURI()"+App.class.getClassLoader().getResource(fileName));
    ...
    public static void createAndPopulateSimpleBucket() throws Exception {
        ...
        File file = new File(App.class.getClassLoader().getResource(fileName).toURI());
